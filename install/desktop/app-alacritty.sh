...
cp ~/.local/share/linux-setup/configs/alacritty.toml ~/.config/alacritty/alacritty.toml
...
source ~/.local/share/linux-setup/install/desktop/set-alacritty-default.sh